    ...
    **/
        ...
        ok.click(function() {
            ...
            if (image.useAjax) {
                $.ajax({
                    ...
                    url: image.saveUrl,
                    data: form.serialize(),
                    error: function(e) { alert("An error occured saving that note:"+JSON.stringify(e)) },
    ...
    $.fn.annotateImage.saveAsHtml = function(image, target) {
        ...
        for (var i = 0; i < image.notes.length; i++) {
            ...
            html += $.fn.annotateImage.createHiddenField("type_" + i, image.notes[i].type);
        }
        element.html(html);
    };
    ...
    $.fn.annotateView = function(image, note) {
        ...
        // Add the area
        this.area = $('<div class="image-annotate-area image-annotate-area-' + note.type + (this.editable ? ' image-annotate-area-editable' : '') + '"><div></div></div>');
    ...
    $.fn.annotateImage.appendPosition = function(form, editable) {
        ...
        var areaFields = $('<input type="hidden" value="' + editable.area.height() + '" name="height"/>' +
                           ...
                           '<input type="hidden" value="' + editable.note.type + '" name="type"/>');
